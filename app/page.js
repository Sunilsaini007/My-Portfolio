    ...
    <div className="overflow-x-hidden dark:bg-black text-black dark:text-white">
      ...
      <>
        {FirstSection.map((items, index) => (
          <div key={index} className="relative h-screen w-full border-none dark:bg-black text-black dark:text-white">
        ...
        <div className="mx-auto max-w-[1400px] dark:bg-black text-black dark:text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mx-5 my-10 text-white">
                ...
                return (
                  ...
                  >
                    <Link href="/somehook" className="block">
                      <div className="relative aspect-video rounded-2xl overflow-hidden shadow-md shadow-gray-500">
                        <Image
                          src={item.img}
                          alt={item.text2}
                          fill
                        ...
                        <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 to-transparent p-5 text-white space-y-3">
                          <h1 className="font-semibold text-lg">{item.text}</h1>
                          <p className="text-sm text-gray-200">{item.text1}</p>
                          <button className="px-3 py-1 border rounded-md hover:text-neutral-400 transition">
                            {item.button}
                          </button>
                        </div>
                      </div>
